> **Superseded:** The dual YuNet/YOLOX presence plan in this document has been
> replaced by the [YuNet-only foreground presence design](2026-07-15-yunet-only-foreground-presence-design.md).
> The remaining historical implementation plan is preserved below.
